...
public class LongestIncreasingSequence {
	...
	private static void printIncreasingSequencesOfIntegers(ArrayList<ArrayList<Integer>> sequencesOfIntegersCollection) {
		...
		sequencesOfIntegersCollection.get(index).forEach(n -> System.out.print(n + " "));
		System.out.println();
	}

	private static int getLongestIncreasingSequenceOfIntegers(ArrayList<ArrayList<Integer>> sequencesOfIntegersCollection) {
